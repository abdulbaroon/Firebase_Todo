"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[452],{5210:function(e,t,r){r.d(t,{C:function(){return ti},X:function(){return eB},Y:function(){return eX},aa:function(){return e8},ab:function(){return e7},ak:function(){return tt},c:function(){return tL},o:function(){return rc},y:function(){return tr}});var i,n=r(5723),s=r(8954),a=r(9858),o=r(9703),l=r(6574);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e9(e,t,r=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let i="signIn",s=await e3(e,i,t),a=await eZ._fromIdTokenResponse(e,i,s);return r||await e._updateCurrentUser(a.user),a}async function e5(e,t){return e9(ey(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
